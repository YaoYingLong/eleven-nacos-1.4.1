...
public class NacosNamingService implements NamingService {
    ...
    private void initCacheDir() {
        ...
        if (!StringUtils.isBlank(jmSnapshotPath)) {
            cacheDir = jmSnapshotPath + File.separator + "nacos" + File.separator + "naming" + File.separator + namespace;
        } else {
            cacheDir = System.getProperty("user.home") + File.separator + "nacos" + File.separator + "naming" + File.separator + namespace;
        }
    }
    ...
    public void registerInstance(String serviceName, String groupName, Instance instance) throws NacosException {
        ...
        if (instance.isEphemeral()) { // 若是AP模式
            ...
            beatReactor.addBeatInfo(groupedServiceName, beatInfo); // 添加心跳
        }
